...
SECRET_KEY = "django-insecure-_o!b45v-w_w6#-bh+kp3r_5w24zsqm!g6#so-diw^gktg01)9i"
...
# Supabase Storage Configuration (django-storages via boto3)
    ...
    STORAGES = {
        "default": {
            ...
            "OPTIONS": {
                ...
                "bucket_name": os.environ.get('AWS_STORAGE_BUCKET_NAME', 'kyc-documents'),
